...
version: 1
status: active
intent: Execute impeccable optimize with explicit authority, state, outputs, and evidence.
use_when: [the task matches impeccable optimize]
...
resume_contract: task-scoped .agents/workflows/impeccable-optimize.json using the workflows directory contract
next_workflows: [none]
profiles: [general]
---
