...
version: 1
status: active
intent: Execute spatial concept with explicit authority, state, outputs, and evidence.
use_when: [the task matches spatial concept]
...
Write `.agents/contexts/spatial/anti-template-preflight.md`.
...
Before writing the thesis, run a short concept forge with the user using `skills/spatial-experience-design/reference/concept-forge-questions.md`.
...
If the user is unsure, propose three mixed concepts:
...
Write `.agents/contexts/spatial/visual-thesis.md`.
...
Gate: Do not skip the user collaboration unless the user explicitly gives you a complete concept.

### STEP 3: Build The Room Sequence

Write `.agents/contexts/spatial/room-sequence.md`.
...
Write `.agents/contexts/spatial/brand-to-scene-translation.md`.
...
Write `.agents/contexts/spatial/showroom-choreography.md`.
...
Write `.agents/contexts/spatial/portfolio-proof-chapters.md`.
...
Update `.agents/contexts/spatial/visual-thesis.md` or create `.agents/contexts/spatial/audit-adaptation-map.md` with:
...
### STEP 8: Write the user's Asset Directive

Use `skills/spatial-experience-design/reference/scene-kit-and-asset-directive.md`.

Write `.agents/contexts/spatial/beloved-asset-directive.md`.
...
Pause here. Do not write final layout styling for image-native scenes until the user places the blocking assets in the specified folders or explicitly approves temporary stand-ins.

### STEP 9: Define The Hero Event

Write `.agents/contexts/spatial/hero-event-blueprint.md`.

Include:

- Composition Reference: Consult [hero-layout-blueprints.md](../reference/hero-layout-blueprints.md) for layout formula or aesthetic reference (e.g., Split, Magazine, Annotated) and define how it is adapted or hybridized for this brand's visual thesis.
- Start state.
- Physical event.
...
Write `.agents/contexts/spatial/scene-kit-brief.md`.
...
Write `.agents/contexts/spatial/cinematic-prompt-pack.md` when image-native or video-native assets are generated.
...
- `.agents/contexts/brand-diagnostics.md`
...
- `.agents/contexts/spatial/portfolio-proof-chapters.md`
...
- the user's Asset Directive and blocked assets.
- Hero event.
- Scene kit.
