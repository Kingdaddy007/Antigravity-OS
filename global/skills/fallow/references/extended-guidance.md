...
- [Common Workflows](#common-workflows)
  - [Audit a project for cleanup opportunities](#audit-a-project-for-cleanup-opportunities)
  - [Find only unused exports (smaller output)](#find-only-unused-exports-smaller-output)
  - [Check if a PR introduces quality risk](#check-if-a-pr-introduces-quality-risk)
  - [Find code duplication](#find-code-duplication)
  - [Safe auto-fix cycle](#safe-auto-fix-cycle)
  - [Discover project structure](#discover-project-structure)
  - [Production-only analysis](#production-only-analysis)
  - [Analyze specific workspaces](#analyze-specific-workspaces)
  - [Scope to specific files (lint-staged)](#scope-to-specific-files-lint-staged)
  - [Catch typos in entry file exports](#catch-typos-in-entry-file-exports)
  - [Debug why something is flagged](#debug-why-something-is-flagged)
  - [Migrate from knip or jscpd](#migrate-from-knip-or-jscpd)
  - [Initialize a new config](#initialize-a-new-config)
...
- [CLI Reference](cli-reference.md): complete command and flag specifications
- [Gotchas](gotchas.md): common pitfalls, edge cases, and correct usage patterns
- [Patterns](patterns.md): workflow recipes for CI, monorepos, migration, and incremental adoption
...
For the full list with examples, see [gotchas.md](gotchas.md).
