...
- [Design & Delivery Models](#design-delivery-models)
...
- [Growth & Scaling Models](#growth-scaling-models)
...
- **page-cro**: Use triggers and psychology in popups
- **pricing-page optimization**: See page-cro for pricing psychology
- **testing**: Test psychological hypotheses
