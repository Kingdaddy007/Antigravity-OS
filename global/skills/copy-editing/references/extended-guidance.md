...
- [Quick-Pass Editing Checks](#quick-pass-editing-checks)
  ...
  - [Paragraph-Level Checks](#paragraph-level-checks)
...
- [Working with Copy Sweeps](#working-with-copy-sweeps)
- [References](#references)
- [Content Refresh Editing](#content-refresh-editing)
...
- [Plain English Alternatives](plain-english-alternatives.md): Replace complex words with simpler alternatives
- [Content Refresh](content-refresh.md): Full checklist, refresh vs. rewrite matrix, and cadence guide
...
**For the full refresh checklist, refresh vs. rewrite decision matrix, and cadence guide**: See [content-refresh.md](content-refresh.md)
...
- **testing**: For testing copy variations
